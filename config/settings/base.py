...
LOCAL_APPS = [
    ...
    "kquires.categories",
    "kquires.articles",
    "kquires.message_alerts",
    "kquires.logs",
    "kquires.departments",
    "kquires.notifications",
    "kquires.chatbot",
...
MIGRATION_MODULES = {"sites": "kquires.contrib.sites.migrations"}

# AUTHENTICATION
# ------------------------------------------------------------------------------
# https://docs.djangoproject.com/en/dev/ref/settings/#authentication-backends
AUTHENTICATION_BACKENDS = [
    "kquires.users.authentication.EmailOrEmployeeIDBackend",
...
STATIC_UPLOADS = BASE_DIR / "static"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "kquires.users.context_processors.allauth_settings",
                "kquires.articles.context_processors.current_language",
            ],
        },
    },
]
...
ADMINS = [("""usman""", "techanzy@gmail.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "kquires.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"login": "kquires.users.forms.CustomLoginForm", "signup": "kquires.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "kquires.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "kquires.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "kquires API",
    "DESCRIPTION": "Documentation of API endpoints of kquires",
    "VERSION": "1.0.0",
...
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': 'full',
        'allowedContent': True,  # ✅ Allow all HTML elements, including images
        'extraAllowedContent': 'img[*]{*}; p[*]{*}; figure[*]{*}; figcaption[*]{*};',
        'removePlugins': 'image',  # ✅ Prevent CKEditor from overriding image handling
    }
}
